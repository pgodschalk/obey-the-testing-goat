...
class SharingTest(FunctionalTest):
    def test_can_share_a_list_with_another_user(self):
        ...
        # She shares her list. The page updates to say that it's shared with
        # Oniciferous:
        list_page.share_list_with("oniciferous@example.org")
        ...
        self.wait_for(
            lambda: self.assertEqual(list_page.get_list_owner(), "edith@example.org")
        )
